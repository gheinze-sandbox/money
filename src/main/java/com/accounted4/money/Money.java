...
public final class Money implements Serializable, Comparable<Money> {
    ...
    private static final String PACKAGE_NAME = "com.accounted4.money";
    
    // System defaults for currency and rounding
    private static final String ROUNDING_MODE_USER_PREF_KEY = "roundingMode";
    private static final String ROUNDING_MODE_USER_DEFAULT = "CEILING";
    
    private static final String CURRENCY_USER_PREF_KEY = "currency";
    private static final String CURRENCY_USER_DEFAULT = "CAD";
    
    
    /*-------------------------------
     * User defaults via Preferences API
     *-------------------------------
     */
    public static RoundingMode getDefaultRoundingMode() {
        return RoundingMode.valueOf(
                Preferences.userRoot().node(PACKAGE_NAME)
                        .get(ROUNDING_MODE_USER_PREF_KEY, ROUNDING_MODE_USER_DEFAULT)
        );
    }
    ...
    public static Currency getDefaultCurrency() {
        return Currency.getInstance(
                Preferences.userRoot().node(PACKAGE_NAME)
                        .get(CURRENCY_USER_PREF_KEY, CURRENCY_USER_DEFAULT)
        );
    }
    ...
    public Money(final BigDecimal amount) {
        this(amount, getDefaultCurrency(), getDefaultRoundingMode());
    }
    ...
    public Money(final String amount, final Currency currency) {
        this(new BigDecimal(amount), currency, getDefaultRoundingMode());
    }
    
    public Money(final String amount) {
        this(new BigDecimal(amount), getDefaultCurrency(), getDefaultRoundingMode());
    }
